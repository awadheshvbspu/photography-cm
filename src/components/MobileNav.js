...
export default function MobileNav() {
  ...
  return (
    ...
    <motion.div variants={menuVariant} initial='hidden' animate={openMenu ? 'show' : ''} className='bg-white shadow-2xl w-full absolute top-0 right-0 max-w-xs h-screen z-20'>
